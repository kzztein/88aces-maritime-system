...
if (isset($_GET['debug'])) {
    ...
    echo "training_type from DB: [" . $type . "]\n";
    echo "cert_number: " . $row['cert_number'] . "\n";
    echo "attendee_id: " . $attendeeId . "\n";
    exit;
}
// ──────────────────────────────────────────────────────────
...
// ============================================================
// PDOS CERTIFICATE — matches original template exactly
// ============================================================
function buildPDOS(
    string $fn, string $mi, string $sn,
...
/* ── Header area: PDOS image + titles stacked, watermark behind ── */
.header-area{
    position:relative;
    text-align:center;
    margin-bottom:3mm;
...
.seminar-text{
    font-size:13pt;font-weight:900;color:#003087;
...
.certify{
    ...
    line-height:1.9;margin:3mm 0;
    text-align:justify;
}
.certify u{text-decoration:underline;}

/* ── Thick bottom divider ── */
.div-bottom{border-top:3px solid #000;margin:3mm 0 0;}
...
<table class="info-table">
  <tr>
    ...
    <td class="col">:</td>
    <td class="val">{$nameVal}</td>
  </tr>
  <tr>
    <td class="lbl">Skill / Occupation</td>
    <td class="col">:</td>
    <td class="val">{$rankVal}</td>
  </tr>
  <tr>
